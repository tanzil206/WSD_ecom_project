...
//
//    @Test
//    void api_should_not_return_Customer_wishList() {
//        ResponseEntity<Customer> customer =
//                customerApiEndPoint.getForEntity("/api/customer/wishlist/tanzir207", Customer.class);
//        assertThat(customer.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
//    }
//}
